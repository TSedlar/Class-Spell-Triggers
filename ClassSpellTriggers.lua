...
local function AddSharedTriggers()
    ...
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Binding Heal", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Flash Heal", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Greater Heal", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Flash of Light", "Clearcasting")

    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Regrowth", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Deft Touch", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Bash", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Claw", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Demoralizing Roar", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Entangling Roots", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Feral Charge", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Ferocious Bite", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Healing Touch", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Hurricane", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Insect Swarm", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Maul", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Moonfire", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Nature's Grasp", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Pounce", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Rake", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Ravage", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Rejuvenation", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Rip", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Shred", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Starfire", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Swiftmend", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Swipe", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Thorns", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Tranquility", "Clearcasting")
    SpellAuraUtil:HandleWidgetActiveGlow(SpellWidgets, PlayerAuras, "Wrath", "Clearcasting")
end
